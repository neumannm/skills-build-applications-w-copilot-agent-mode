    ...
    <>
      ...
      <div className="container">
        <Routes>
          ...
          <Route path="/" element={<div className="text-center mt-5"><h1 className="display-4 fw-bold">Willkommen bei Octofit Tracker!</h1><p className="lead">Deine Fitness, dein Team, dein Fortschritt.</p></div>} />
        </Routes>
      </div>
    </>
  );
